    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests((authz) -> authz
                        ...
                        .requestMatchers(HttpMethod.PUT,"/courses/{courseId}").permitAll()
                        ...
                        .requestMatchers("/courses/create", "/admin/**", "/courses/{courseId}/topics/{topicId}/delete",
                                ...
                                "/courses/create","/courses/{courseId}/topics/create","/createCourse", "/course/{courseId}").hasAnyAuthority(EnumeratedRole.TEACHER.name())
                        .requestMatchers("/admin", "/admin/**", "/courses/{courseId}/delete").hasAnyAuthority(EnumeratedRole.ADMIN.name())
                        .requestMatchers(HttpMethod.GET, "/courses/{courseId}/topics/{topicId}/completed",
                                "/courses/{courseId}/checkEnroll","/courses/{id}/getProgress").hasAnyAuthority(EnumeratedRole.STUDENT.name())
                        .requestMatchers(HttpMethod.POST,"/courses/{courseId}/topics/{topicId}/save_topic_progress",
                                ...
                                "/feedbacks").hasAnyAuthority(EnumeratedRole.STUDENT.name())
                )
